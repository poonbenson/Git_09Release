...
################################################################################
## Form generated from reading UI file 'bigKeeperPyUi_newLayout_v124.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabWidget_2.setGeometry(QRect(0, 290, 411, 311))
        font1 = QFont()
        ...
        self.pushButton_genWritePrerend_2 = QPushButton(self.tabMisc)
        self.pushButton_genWritePrerend_2.setObjectName(u"pushButton_genWritePrerend_2")
        self.pushButton_genWritePrerend_2.setGeometry(QRect(10, 30, 121, 23))
        self.label_22 = QLabel(self.tabMisc)
        self.label_22.setObjectName(u"label_22")
        self.label_22.setGeometry(QRect(10, 10, 121, 16))
        self.pushButton_genWritePrerend_3 = QPushButton(self.tabMisc)
        self.pushButton_genWritePrerend_3.setObjectName(u"pushButton_genWritePrerend_3")
        self.pushButton_genWritePrerend_3.setGeometry(QRect(10, 60, 121, 23))
        self.pushButton_genWritePrerend_4 = QPushButton(self.tabMisc)
        self.pushButton_genWritePrerend_4.setObjectName(u"pushButton_genWritePrerend_4")
        self.pushButton_genWritePrerend_4.setGeometry(QRect(10, 90, 121, 23))
...
"(pushButton_2)", None))
        ...
        self.pushButton_shotlist.setText(QCoreApplication.translate("MainWindow", u"Shotlist", None))
        self.pushButton_roughcut.setText(QCoreApplication.translate("MainWindow", u"Roughcut", None))
        self.pushButton_dailyFolder2.setText(QCoreApplication.translate("MainWindow", u"Daily", None))
        self.pushButton_commentClient.setText(QCoreApplication.translate("MainWindow", u"Comment (of Client)", None))
...
#if QT_CONFIG(tooltip)
        self.pushButton_genWritePrerend_2.setToolTip(QCoreApplication.translate("MainWindow", u"pushButton_genWritePrerend", None))
#endif // QT_CONFIG(tooltip)
        self.pushButton_genWritePrerend_2.setText(QCoreApplication.translate("MainWindow", u"Big Keeper Cookbook", None))
        self.label_22.setText(QCoreApplication.translate("MainWindow", u"Misc:", None))
#if QT_CONFIG(tooltip)
        self.pushButton_genWritePrerend_3.setToolTip(QCoreApplication.translate("MainWindow", u"pushButton_genWritePrerend", None))
#endif // QT_CONFIG(tooltip)
        self.pushButton_genWritePrerend_3.setText(QCoreApplication.translate("MainWindow", u"Login ID and Password", None))
#if QT_CONFIG(tooltip)
        self.pushButton_genWritePrerend_4.setToolTip(QCoreApplication.translate("MainWindow", u"pushButton_genWritePrerend", None))
#endif // QT_CONFIG(tooltip)
        self.pushButton_genWritePrerend_4.setText(QCoreApplication.translate("MainWindow", u"Contact Sheet", None))
